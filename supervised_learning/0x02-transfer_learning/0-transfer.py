...
ResNet = K.applications.InceptionResNetV2(include_top=False,       weights='imagenet', input_shape=(299, 299, 3))

#Preprocessing layers

inputs = K.Input(shape=(32, 32, 3)
input = K.layers.Lambda(lambda image : K.backend.resize_images(image, 299/32, 299/32, data_format='channels_last'))(inputs)
